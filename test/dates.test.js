import { dayOfTheFirstOfMonth, dayOfTheWeek, dayNameOfTheWeek, hasFridayThirteenth, numberOfFriday13thsThisYear } from '../dates.js';
...
describe('Date operations', () => {
    ...
    test('Can tell you what day a month started on', () => {
        ...
        expect(dayOfTheFirstOfMonth(2019, 2)).toEqual(5);
         // Saturday 1st February, 2020
        expect(dayOfTheFirstOfMonth(2020, 1)).toEqual(6);
         // Monday 1st November, 2021
        expect(dayOfTheFirstOfMonth(2021, 10)).toEqual(1);
    });
});
...
describe('Test for day of the week', () => {    
    ...
    test('Test that April 11, 2018 was a Wednesday', () => {
       expect(dayOfTheWeek(2018, 3, 11)).toEqual(3);
    });

    test('Test that the Moon landing was on a Sunday', () => {
        expect(dayOfTheWeek(1969, 6, 20)).toEqual(0);
    });

    test('Test that Independence Day 1776 was on a Thursday', () => {
        expect(dayOfTheWeek(1776, 6, 4)).toEqual(4);
    });

    test('Test for the day name of Independence Day', () => {
        expect(dayNameOfTheWeek(1776, 6, 4)).toContain('Thursday');
    })

    test('Test for the day name of the Moon Landing', () => {
        expect(dayNameOfTheWeek(1969, 6, 20)).toContain('Sunday');
    })
});
...
describe('Test for Friday 13th', () => {
    ...
    test('April 2018 does have a Friday 13th', () => {
        result = hasFridayThirteenth(2018, 3);
        expect(result).toBe(true);
    });

    test('May 2018 does not have a Friday 13th', () => {
        result = hasFridayThirteenth(2018, 4);
...
describe('Test for number of Friday 13th in a year', () => {
    ...
    test('Number of Friday 13ths in 2000 was 1', () => {
        result = numberOfFriday13thsThisYear(2000);
        expect(result).toEqual(1);
    });

    test('Number of Friday 13ths in 2017 was 2', () => {
        result = numberOfFriday13thsThisYear(2017);
        expect(result).toEqual(2);
    });

    test('Number of Friday 13ths in 2015 was 3', () => {
        result = numberOfFriday13thsThisYear(2015);
